...
@Application @DeleteRecordAccess
...
@JobOrder @DeleteRecordAccess
Scenario Outline: Validate access to delete a Job Order
	Given <User> logs-in and navigates to 'Job Order' Page
	Then validate delete icon is displayed on selection of a record
	And User should log-out of the Application
	Examples:
	| User |
...
@Lead @DeleteRecordAccess
Scenario Outline: Validate access to delete a Lead 
